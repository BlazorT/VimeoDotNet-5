    ...
    public partial class VimeoClient
    {
        ...
        private async Task<string> UploadPictureAsync(IBinaryContent fileContent, long clipId)
        {
            try
            {
                ...
                JsonDocument.Parse(postResponse.Text).RootElement.TryGetProperty("link", out var link);
                JsonDocument.Parse(postResponse.Text).RootElement.TryGetProperty("uri", out var uri);
